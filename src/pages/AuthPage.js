...
export default function AuthPage({ onBack }) {
  ...
  return (
    <div className="ms-auth-wrap">
      <button type="button" className="ms-btn-ghost ms-btn-ghost--sm ms-btn-ghost--nav" onClick={onBack}>
        ← Back
      </button>
      ...
      <div className="ms-glass-card ms-glass-card--narrow">
        ...
        <div className="ms-form-stack">
          ...
          <div>
            <label className="ms-label" htmlFor="auth-user">
          ...
          <div>
            ...
            <input
              ...
              className="ms-input"
              type="password"
              placeholder={tab === 'login' ? 'Enter password' : 'Min 6 characters'}
              value={form.password}
          ...
          <button type="button" className="ms-btn-primary" onClick={handleSubmit} disabled={loading}>
